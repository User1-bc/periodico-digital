<?php
// Test push from crear_anuncio.php logic
require_once 'conexion.php';

$cliente_nombre = "Test Anuncio " . date('H:i:s');
$tituloPush = "📢 Nuevo Anuncio: " . $cliente_nombre;
$mensajePush = "Nuevo anuncio disponible en la sección de publicidad";

require_once 'admin.php'; // This has the enviarPushNotificacion function

// Actually let's just copy the function here
...
$result = enviarPushNotificacion($pdo, $tituloPush, $mensajePush, '/');
